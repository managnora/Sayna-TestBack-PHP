...
class AuthController extends ApiController
{
    ...
    public function register(Request $request, ValidatorInterface $validator, AuthenticationSuccessHandler $successHandler): JsonResponse
    {
        ...
        $input = ['firstname' => $firstname, 'lastname' => $lastname, 'email' => $email, 'password' => $password, 'date_naissance' => $dateNaissance];
        ...
        $constraints = new Assert\Collection([
            ...
            'password' => [new Assert\Regex($pattern), new Assert\notBlank],
            'date_naissance' => [new Assert\Date(), new Assert\notBlank]
        ]);
